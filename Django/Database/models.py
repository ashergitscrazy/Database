...
class Course(models.Model):
    ...
    resident_cost = models.DecimalField(max_digits=4, decimal_places=0, default=0)
    non_resident_cost = models.DecimalField(max_digits=4, decimal_places=0, default=0)
